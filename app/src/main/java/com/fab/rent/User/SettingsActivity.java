...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        securityQues=findViewById(R.id.security_questions);
    ...
    private void updateOnlyUserInfo() {
        ...
        startActivity(new Intent(SettingsActivity.this, UserHome.class));
    ...
    private  void uploadImage()
    {
        ...
        if(imageUri!=null)
        {
            final StorageReference filRef=storageProfilePictureRef.child(Prevalent.currentOnlineUser.getPhone() + ".jpg");
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            if(task.isSuccessful())
                            {
                                ...
                                startActivity(new Intent(SettingsActivity.this,UserHome.class));   //changes done here
                                Toast.makeText(SettingsActivity.this, "Profile Info Updated Successfully", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                            else
